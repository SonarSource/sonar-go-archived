...
class UastNode {
  ...
  enum Kind {
    ...
    PREFIX_DECREMENT,
    PREFIX_INCREMENT,
    LOGICAL_COMPLEMENT("!", OPERATOR),
    BITWISE_COMPLEMENT("^", OPERATOR),
    ANNOTATION, ANNOTATION_TYPE, ARGUMENTS, CATCH, CONDITIONAL_EXPRESSION, ARGUMENT, ASSERT, EMPTY_STATEMENT, TYPE_ARGUMENTS, TYPE_ARGUMENT, TYPE_PARAMETERS, TYPE_PARAMETER;
