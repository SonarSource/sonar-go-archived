...
const (
	...
	ARRAY_ACCESS_EXPRESSION   Kind = "ARRAY_ACCESS_EXPRESSION"
	ARRAY_OBJECT_EXPRESSION   Kind = "ARRAY_OBJECT_EXPRESSION"
	ARRAY_KEY_EXPRESSION      Kind = "ARRAY_KEY_EXPRESSION"
)
