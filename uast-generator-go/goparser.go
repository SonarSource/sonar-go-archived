...
var (
	...
	OPERATOR_BINARY_AND       = NewKind("OPERATOR_BINARY_AND")
	OPERATOR_BINARY_AND_NOT   = NewKind("OPERATOR_BINARY_AND_NOT")
	OPERATOR_BINARY_OR        = NewKind("OPERATOR_BINARY_OR")
	OPERATOR_BINARY_XOR       = NewKind("OPERATOR_BINARY_XOR")
