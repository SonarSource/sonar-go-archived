    ...
    if (orchestrator.getServer().version().isGreaterThanOrEquals("7.2")) {
      ...
      assertThat(formatIssues(issues)).isEqualTo(
        "SelfAssignement.go|external_golint:generic|MAJOR|5min|line:1|package comment should be of the form \"Package samples ...\"\n" +
          ...
          "TabCharacter.go|external_golint:generic|MAJOR|5min|line:1|package comment should be of the form \"Package samples ...\"\n" +
          "TodoTagPresence.go|external_golint:generic|MAJOR|5min|line:1|package comment should be of the form \"Package samples ...\"\n" +
          "TooLongLine.go|external_golint:generic|MAJOR|5min|line:1|package comment should be of the form \"Package samples ...\"\n" +
          "TooManyParameters.go|external_golint:generic|MAJOR|5min|line:1|package comment should be of the form \"Package samples ...\"\n" +
          "pivot.go|external_golint:generic|MAJOR|5min|line:10|don't use underscores in Go names; var ascii_uppercase should be asciiUppercase\n" +
          "pivot.go|external_golint:generic|MAJOR|5min|line:11|don't use underscores in Go names; var ascii_lowercase should be asciiLowercase\n" +
          "pivot.go|external_golint:generic|MAJOR|5min|line:12|don't use underscores in Go names; var ascii_uppercase_len should be asciiUppercaseLen\n" +
          "pivot.go|external_golint:generic|MAJOR|5min|line:13|don't use underscores in Go names; var ascii_lowercase_len should be asciiLowercaseLen\n" +
          "pivot.go|external_golint:generic|MAJOR|5min|line:14|don't use underscores in Go names; var ascii_allowed should be asciiAllowed");
    } else {
      assertThat(issues).isEmpty();
    }
  }
