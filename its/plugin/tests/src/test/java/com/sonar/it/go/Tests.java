...
public class Tests {
  ...
  private static final String GO_PLUGIN_BUILD_DIR = "../../../sonar-go-plugin/build/libs";
  private static final String GO_PLUGIN_JAR_PATTERN = "sonar-go-plugin-*-all.jar";
  private static final FileLocation GO_PLUGIN_LOCATION = FileLocation.byWildcardMavenFilename(new File(GO_PLUGIN_BUILD_DIR), GO_PLUGIN_JAR_PATTERN);
